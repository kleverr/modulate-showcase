...
(function () {
  ...
  const DEMO_MUSIC_DATA = (function () {
    const probs = [
      [0.9430,0.0917],[0.9921,0.0840],[0.9962,0.0713],[0.9952,0.0525],[0.9988,0.0454],
      [0.9993,0.0386],[0.9991,0.0339],[0.9992,0.0337],[0.9995,0.0473],[0.9995,0.0601],
      [0.9991,0.0802],[0.9984,0.1175],[0.9962,0.2317],[0.9968,0.3544],[0.9960,0.4681],
      [0.9968,0.5766],[0.9945,0.6103],[0.9916,0.6182],[0.9909,0.6043],[0.9917,0.6426],
      [0.9930,0.6248],[0.9919,0.5697],[0.9915,0.5020],[0.9908,0.5010],[0.9902,0.4763],
      [0.9940,0.4442],[0.9948,0.4365],[0.9933,0.4390],[0.9925,0.4380],[0.9926,0.4298],
      [0.9948,0.4514],[0.9945,0.4623],[0.9951,0.4206],[0.9947,0.4035],[0.9928,0.3862],
      [0.9909,0.3615],[0.9925,0.3820],[0.9940,0.3882],[0.9947,0.4663],[0.9935,0.5578],
      [0.9933,0.5875],[0.9918,0.5540],[0.9921,0.5251],[0.9914,0.5089],[0.9942,0.5337],
      [0.9940,0.5261],[0.9965,0.5324],[0.9979,0.6305],[0.9953,0.6840],[0.9925,0.6924],
      [0.9923,0.7374],[0.9912,0.7425],[0.9904,0.7134],[0.9930,0.6857],[0.9872,0.6242],
      [0.9875,0.5417],[0.9858,0.5567],[0.9846,0.5930],[0.9833,0.7020],[0.9822,0.8112],
      [0.9788,0.8530],[0.9805,0.8849],[0.9807,0.9075],[0.9797,0.9100],[0.9777,0.8898],
      [0.9773,0.8646],[0.9768,0.9154],[0.9806,0.9028],[0.9803,0.9134],[0.9769,0.9061],
      [0.9796,0.8825],[0.9787,0.8011],[0.9779,0.7052],[0.9727,0.5974],[0.9698,0.6179],
      [0.9401,0.6952],[0.9497,0.7506],[0.9637,0.8380],
    ];
    const FRAME_S = 0.192;
