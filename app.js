...
(function () {
  ...
  const DEMO_MUSIC_DATA = (function () {
    const probs = [
      [0.9279,0.1536],[0.9661,0.1237],[0.9824,0.0962],[0.9843,0.1292],[0.9831,0.5761],
      [0.9654,0.9000],[0.9679,0.9623],[0.9684,0.9736],[0.9666,0.9897],[0.9627,0.9814],
      [0.9585,0.9768],[0.9532,0.9720],[0.9524,0.9846],[0.9522,0.9829],[0.9501,0.9746],
      [0.9470,0.9782],[0.9425,0.9638],[0.9379,0.9875],[0.9386,0.9886],[0.9455,0.9916],
      [0.9442,0.9928],[0.9560,0.9979],[0.9550,0.9976],[0.9440,0.9880],[0.9389,0.9926],
      [0.9519,0.9816],[0.9532,0.9811],[0.9573,0.9276],[0.9663,0.6107],[0.9688,0.2325],
      [0.9731,0.0951],[0.9735,0.0437],[0.9732,0.0254],[0.9767,0.0190],[0.9797,0.0152],
      [0.9822,0.0146],[0.9804,0.0185],[0.9803,0.0359],[0.9751,0.1167],[0.9683,0.8189],
      [0.9487,0.9942],[0.9485,0.9998],[0.9464,1.0000],[0.9299,1.0000],[0.9301,0.9998],
      [0.8964,0.9985],[0.8943,0.9986],[0.8894,0.9969],[0.8895,0.9421],[0.8797,0.6772],
      [0.8748,0.3071],[0.8753,0.1304],[0.8769,0.0698],[0.8682,0.0489],[0.8582,0.0419],
      [0.8258,0.0673],[0.7694,0.2004],[0.7385,0.2692],[0.7205,0.3032],[0.7148,0.3296],
      [0.6673,0.4579],[0.6237,0.6777],[0.6646,0.9562],[0.6689,0.9957],[0.6797,0.9961],
      [0.6805,0.9819],[0.6803,0.8966],[0.6520,0.6460],[0.6464,0.4048],[0.6811,0.3612],
      [0.6826,0.8205],[0.6420,0.9723],[0.6384,0.9911],[0.6372,0.9959],[0.6411,0.9984],
      [0.6510,0.9982],[0.6982,0.9977],[0.7140,0.9856],
    ];
    const FRAME_S = 0.192;
